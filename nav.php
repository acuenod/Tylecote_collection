...
<ul class="navbar">
    ...
    if(isset($_SESSION["access"]) && $_SESSION["access"]>1)
    {
      ...
      <li onmouseover="this.className=\'navbar_highlighted\' " onmouseout="this.className=\'navbar_normal\' " onclick="document.location.href =\'/Tylecote_collection/writer/link.php\' "; class="navbar_normal"><a href="/Tylecote_collection/writer/link.php">Link items</a>
      ';
    }
